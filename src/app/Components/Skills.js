  ...
  return (
    <div id='Testimonials' className="bg-white md:px-20 md:py-24 px-4 py-16 dark:bg-[#030712]">
      ...
      <div className="grid md:grid-cols-8 grid-cols-3 md:gap-12 gap-6 ">
        <Planguage className="dark:text-[#D1D5DB]" text="Javascript" source="/icon-javscript.svg"/>
        ...
        <Planguage text="Express.js" source= {!props.darkModeOn?("/icon-express.svg"):"/icon-express_dark.png"}/>
        <Planguage text="Nest.js" source="/icon-nest.svg"/>
        <Planguage text="Socket.io" source={!props.darkModeOn?("/icon-socket.png"):"/icon-socket_dark.png"}/>
        ...
        <Planguage text="Cypress" source={!props.darkModeOn?("/icon-cypress.svg"):"/icon-cypress_dark.png"}/>
