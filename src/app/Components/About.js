...
export const About = () => {
  return (
    <div className="bg-[#F9FAFB] md:px-20 md:py-24 px-4 py-16 w-full flex flex-col gap-12">
      ...
      <div className="AboutMe flex flex-col md:flex-row px-8 gap-12">
        <div className=" md:h-[360px]  h-[320px] md:w-[400px] h-[300px] mx-auto w-[280px] md:ml-[40px] relative">
          <img
        ...
        <div className="md:w-1/2">
          ...
          <div className="About flex flex-col gap-2 mt-6">
            <p className="text-[#4B5563] font-normal text-base leading-6 text-justify">
